...
PARAM <- list()
PARAM$experimento <- "p04_DR6210"

PARAM$exp_input <- "p04_CA6110"
...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[, Media_mactivos_margen := mean(mactivos_margen, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mpasivos_margen := mean(mpasivos_margen, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcuenta_corriente_adicional := mean(mcuenta_corriente_adicional, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcuenta_corriente := mean(mcuenta_corriente, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcaja_ahorro := mean(mcaja_ahorro, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcaja_ahorro_adicional := mean(mcaja_ahorro_adicional, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcaja_ahorro_dolares := mean(mcaja_ahorro_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcuentas_saldo := mean(mcuentas_saldo, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mautoservicio := mean(mautoservicio, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtarjeta_visa_consumo := mean(mtarjeta_visa_consumo, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtarjeta_master_consumo := mean(mtarjeta_master_consumo, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mprestamos_personales := mean(mprestamos_personales, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mprestamos_prendarios := mean(mprestamos_prendarios, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mprestamos_hipotecarios := mean(mprestamos_hipotecarios, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mplazo_fijo_dolares := mean(mplazo_fijo_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mplazo_fijo_pesos := mean(mplazo_fijo_pesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_minversion1_pesos := mean(minversion1_pesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_minversion1_dolares := mean(minversion1_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_minversion2 := mean(minversion2, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mpayroll := mean(mpayroll, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mpayroll2 := mean(mpayroll2, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcuenta_debitos_automaticos := mean(mcuenta_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mttarjeta_visa_debitos_automaticos := mean(mttarjeta_visa_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mttarjeta_master_debitos_automaticos := mean(mttarjeta_master_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mpagodeservicios := mean(mpagodeservicios, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mpagomiscuentas := mean(mpagomiscuentas, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcajeros_propios_descuentos := mean(mcajeros_propios_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtarjeta_visa_descuentos := mean(mtarjeta_visa_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtarjeta_master_descuentos := mean(mtarjeta_master_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcomisiones_mantenimiento := mean(mcomisiones_mantenimiento, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcomisiones_otras := mean(mcomisiones_otras, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mforex_buy := mean(mforex_buy, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mforex_sell := mean(mforex_sell, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtransferencias_recibidas := mean(mtransferencias_recibidas, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mtransferencias_emitidas := mean(mtransferencias_emitidas, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mextraccion_autoservicio := mean(mextraccion_autoservicio, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcheques_depositados := mean(mcheques_depositados, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcheques_emitidos := mean(mcheques_emitidos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcheques_depositados_rechazados := mean(mcheques_depositados_rechazados, na.rm = TRUE), by = foto_mes]
  dataset[, Media_mcheques_emitidos_rechazados := mean(mcheques_emitidos_rechazados, na.rm = TRUE), by = foto_mes]
  dataset[, Media_matm := mean(matm, na.rm = TRUE), by = foto_mes]
  dataset[, Media_matm_other := mean(matm_other, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_msaldototal := mean(Master_msaldototal, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_msaldopesos := mean(Master_msaldopesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_msaldodolares := mean(Master_msaldodolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mconsumospesos := mean(Master_mconsumospesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mconsumosdolares := mean(Master_mconsumosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_madelantopesos := mean(Master_madelantopesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_madelantodolares := mean(Master_madelantodolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mpagado := mean(Master_mpagado, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mpagospesos := mean(Master_mpagospesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mpagosdolares := mean(Master_mpagosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mconsumototal := mean(Master_mconsumototal, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Master_mpagominimo := mean(Master_mpagominimo, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_msaldototal := mean(Visa_msaldototal, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_msaldopesos := mean(Visa_msaldopesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_msaldodolares := mean(Visa_msaldodolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mconsumospesos := mean(Visa_mconsumospesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mconsumosdolares := mean(Visa_mconsumosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_madelantopesos := mean(Visa_madelantopesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_madelantodolares := mean(Visa_madelantodolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mpagado := mean(Visa_mpagado, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mpagospesos := mean(Visa_mpagospesos, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mpagosdolares := mean(Visa_mpagosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mconsumototal := mean(Visa_mconsumototal, na.rm = TRUE), by = foto_mes]
  dataset[, Media_Visa_mpagominimo := mean(Visa_mpagominimo, na.rm = TRUE), by = foto_mes]
  ...
  dataset[, SD_mactivos_margen := sd(mactivos_margen, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mpasivos_margen := sd(mpasivos_margen, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcuenta_corriente_adicional := sd(mcuenta_corriente_adicional, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcuenta_corriente := sd(mcuenta_corriente, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcaja_ahorro := sd(mcaja_ahorro, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcaja_ahorro_adicional := sd(mcaja_ahorro_adicional, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcaja_ahorro_dolares := sd(mcaja_ahorro_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcuentas_saldo := sd(mcuentas_saldo, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mautoservicio := sd(mautoservicio, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtarjeta_visa_consumo := sd(mtarjeta_visa_consumo, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtarjeta_master_consumo := sd(mtarjeta_master_consumo, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mprestamos_personales := sd(mprestamos_personales, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mprestamos_prendarios := sd(mprestamos_prendarios, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mprestamos_hipotecarios := sd(mprestamos_hipotecarios, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mplazo_fijo_dolares := sd(mplazo_fijo_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mplazo_fijo_pesos := sd(mplazo_fijo_pesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_minversion1_pesos := sd(minversion1_pesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_minversion1_dolares := sd(minversion1_dolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_minversion2 := sd(minversion2, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mpayroll := sd(mpayroll, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mpayroll2 := sd(mpayroll2, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcuenta_debitos_automaticos := sd(mcuenta_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mttarjeta_visa_debitos_automaticos := sd(mttarjeta_visa_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mttarjeta_master_debitos_automaticos := sd(mttarjeta_master_debitos_automaticos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mpagodeservicios := sd(mpagodeservicios, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mpagomiscuentas := sd(mpagomiscuentas, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcajeros_propios_descuentos := sd(mcajeros_propios_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtarjeta_visa_descuentos := sd(mtarjeta_visa_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtarjeta_master_descuentos := sd(mtarjeta_master_descuentos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcomisiones_mantenimiento := sd(mcomisiones_mantenimiento, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcomisiones_otras := sd(mcomisiones_otras, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mforex_buy := sd(mforex_buy, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mforex_sell := sd(mforex_sell, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtransferencias_recibidas := sd(mtransferencias_recibidas, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mtransferencias_emitidas := sd(mtransferencias_emitidas, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mextraccion_autoservicio := sd(mextraccion_autoservicio, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcheques_depositados := sd(mcheques_depositados, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcheques_emitidos := sd(mcheques_emitidos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcheques_depositados_rechazados := sd(mcheques_depositados_rechazados, na.rm = TRUE), by = foto_mes]
  dataset[, SD_mcheques_emitidos_rechazados := sd(mcheques_emitidos_rechazados, na.rm = TRUE), by = foto_mes]
  dataset[, SD_matm := sd(matm, na.rm = TRUE), by = foto_mes]
  dataset[, SD_matm_other := sd(matm_other, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_msaldototal := sd(Master_msaldototal, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_msaldopesos := sd(Master_msaldopesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_msaldodolares := sd(Master_msaldodolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mconsumospesos := sd(Master_mconsumospesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mconsumosdolares := sd(Master_mconsumosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_madelantopesos := sd(Master_madelantopesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_madelantodolares := sd(Master_madelantodolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mpagado := sd(Master_mpagado, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mpagospesos := sd(Master_mpagospesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mpagosdolares := sd(Master_mpagosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mconsumototal := sd(Master_mconsumototal, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Master_mpagominimo := sd(Master_mpagominimo, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_msaldototal := sd(Visa_msaldototal, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_msaldopesos := sd(Visa_msaldopesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_msaldodolares := sd(Visa_msaldodolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mconsumospesos := sd(Visa_mconsumospesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mconsumosdolares := sd(Visa_mconsumosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_madelantopesos := sd(Visa_madelantopesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_madelantodolares := sd(Visa_madelantodolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mpagado := sd(Visa_mpagado, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mpagospesos := sd(Visa_mpagospesos, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mpagosdolares := sd(Visa_mpagosdolares, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mconsumototal := sd(Visa_mconsumototal, na.rm = TRUE), by = foto_mes]
  dataset[, SD_Visa_mpagominimo := sd(Visa_mpagominimo, na.rm = TRUE), by = foto_mes]
  ...
  dataset[, X7_mactivos_margen_normalizada := ifelse(any(is.na(c(mactivos_margen, Media_mactivos_margen, SD_mactivos_margen))), 0, (mactivos_margen - Media_mactivos_margen) / SD_mactivos_margen)]
  dataset[, X7_mpasivos_margen_normalizada := ifelse(any(is.na(c(mpasivos_margen, Media_mpasivos_margen, SD_mpasivos_margen))), 0, (mpasivos_margen - Media_mpasivos_margen) / SD_mpasivos_margen)]
  dataset[, X7_mcuenta_corriente_adicional_normalizada := ifelse(any(is.na(c(mcuenta_corriente_adicional, Media_mcuenta_corriente_adicional, SD_mcuenta_corriente_adicional))), 0, (mcuenta_corriente_adicional - Media_mcuenta_corriente_adicional) / SD_mcuenta_corriente_adicional)]
  dataset[, X7_mcuenta_corriente_normalizada := ifelse(any(is.na(c(mcuenta_corriente, Media_mcuenta_corriente, SD_mcuenta_corriente))), 0, (mcuenta_corriente - Media_mcuenta_corriente) / SD_mcuenta_corriente)]
  dataset[, X7_mcaja_ahorro_normalizada := ifelse(any(is.na(c(mcaja_ahorro, Media_mcaja_ahorro, SD_mcaja_ahorro))), 0, (mcaja_ahorro - Media_mcaja_ahorro) / SD_mcaja_ahorro)]
  dataset[, X7_mcaja_ahorro_adicional_normalizada := ifelse(any(is.na(c(mcaja_ahorro_adicional, Media_mcaja_ahorro_adicional, SD_mcaja_ahorro_adicional))), 0, (mcaja_ahorro_adicional - Media_mcaja_ahorro_adicional) / SD_mcaja_ahorro_adicional)]
  dataset[, X7_mcaja_ahorro_dolares_normalizada := ifelse(any(is.na(c(mcaja_ahorro_dolares, Media_mcaja_ahorro_dolares, SD_mcaja_ahorro_dolares))), 0, (mcaja_ahorro_dolares - Media_mcaja_ahorro_dolares) / SD_mcaja_ahorro_dolares)]
  dataset[, X7_mcuentas_saldo_normalizada := ifelse(any(is.na(c(mcuentas_saldo, Media_mcuentas_saldo, SD_mcuentas_saldo))), 0, (mcuentas_saldo - Media_mcuentas_saldo) / SD_mcuentas_saldo)]
  dataset[, X7_mautoservicio_normalizada := ifelse(any(is.na(c(mautoservicio, Media_mautoservicio, SD_mautoservicio))), 0, (mautoservicio - Media_mautoservicio) / SD_mautoservicio)]
  dataset[, X7_mtarjeta_visa_consumo_normalizada := ifelse(any(is.na(c(mtarjeta_visa_consumo, Media_mtarjeta_visa_consumo, SD_mtarjeta_visa_consumo))), 0, (mtarjeta_visa_consumo - Media_mtarjeta_visa_consumo) / SD_mtarjeta_visa_consumo)]
  dataset[, X7_mtarjeta_master_consumo_normalizada := ifelse(any(is.na(c(mtarjeta_master_consumo, Media_mtarjeta_master_consumo, SD_mtarjeta_master_consumo))), 0, (mtarjeta_master_consumo - Media_mtarjeta_master_consumo) / SD_mtarjeta_master_consumo)]
  ...
  dataset[, X7_mprestamos_prendarios_normalizada := ifelse(any(is.na(c(mprestamos_prendarios, Media_mprestamos_prendarios, SD_mprestamos_prendarios))), 0, (mprestamos_prendarios - Media_mprestamos_prendarios) / SD_mprestamos_prendarios)]
  dataset[, X7_mprestamos_hipotecarios_normalizada := ifelse(any(is.na(c(mprestamos_hipotecarios, Media_mprestamos_hipotecarios, SD_mprestamos_hipotecarios))), 0, (mprestamos_hipotecarios - Media_mprestamos_hipotecarios) / SD_mprestamos_hipotecarios)]
  dataset[, X7_mplazo_fijo_dolares_normalizada := ifelse(any(is.na(c(mplazo_fijo_dolares, Media_mplazo_fijo_dolares, SD_mplazo_fijo_dolares))), 0, (mplazo_fijo_dolares - Media_mplazo_fijo_dolares) / SD_mplazo_fijo_dolares)]
  dataset[, X7_mplazo_fijo_pesos_normalizada := ifelse(any(is.na(c(mplazo_fijo_pesos, Media_mplazo_fijo_pesos, SD_mplazo_fijo_pesos))), 0, (mplazo_fijo_pesos - Media_mplazo_fijo_pesos) / SD_mplazo_fijo_pesos)]
  dataset[, X7_minversion1_pesos_normalizada := ifelse(any(is.na(c(minversion1_pesos, Media_minversion1_pesos, SD_minversion1_pesos))), 0, (minversion1_pesos - Media_minversion1_pesos) / SD_minversion1_pesos)]
  dataset[, X7_minversion1_dolares_normalizada := ifelse(any(is.na(c(minversion1_dolares, Media_minversion1_dolares, SD_minversion1_dolares))), 0, (minversion1_dolares - Media_minversion1_dolares) / SD_minversion1_dolares)]
  dataset[, X7_minversion2_normalizada := ifelse(any(is.na(c(minversion2, Media_minversion2, SD_minversion2))), 0, (minversion2 - Media_minversion2) / SD_minversion2)]
  dataset[, X7_mpayroll_normalizada := ifelse(any(is.na(c(mpayroll, Media_mpayroll, SD_mpayroll))), 0, (mpayroll - Media_mpayroll) / SD_mpayroll)]
  dataset[, X7_mpayroll2_normalizada := ifelse(any(is.na(c(mpayroll2, Media_mpayroll2, SD_mpayroll2))), 0, (mpayroll2 - Media_mpayroll2) / SD_mpayroll2)]
  dataset[, X7_mcuenta_debitos_automaticos_normalizada := ifelse(any(is.na(c(mcuenta_debitos_automaticos, Media_mcuenta_debitos_automaticos, SD_mcuenta_debitos_automaticos))), 0, (mcuenta_debitos_automaticos - Media_mcuenta_debitos_automaticos) / SD_mcuenta_debitos_automaticos)]
  dataset[, X7_mttarjeta_visa_debitos_automaticos_normalizada := ifelse(any(is.na(c(mttarjeta_visa_debitos_automaticos, Media_mttarjeta_visa_debitos_automaticos, SD_mttarjeta_visa_debitos_automaticos))), 0, (mttarjeta_visa_debitos_automaticos - Media_mttarjeta_visa_debitos_automaticos) / SD_mttarjeta_visa_debitos_automaticos)]
  dataset[, X7_mttarjeta_master_debitos_automaticos_normalizada := ifelse(any(is.na(c(mttarjeta_master_debitos_automaticos, Media_mttarjeta_master_debitos_automaticos, SD_mttarjeta_master_debitos_automaticos))), 0, (mttarjeta_master_debitos_automaticos - Media_mttarjeta_master_debitos_automaticos) / SD_mttarjeta_master_debitos_automaticos)]
  dataset[, X7_mpagodeservicios_normalizada := ifelse(any(is.na(c(mpagodeservicios, Media_mpagodeservicios, SD_mpagodeservicios))), 0, (mpagodeservicios - Media_mpagodeservicios) / SD_mpagodeservicios)]
  dataset[, X7_mpagomiscuentas_normalizada := ifelse(any(is.na(c(mpagomiscuentas, Media_mpagomiscuentas, SD_mpagomiscuentas))), 0, (mpagomiscuentas - Media_mpagomiscuentas) / SD_mpagomiscuentas)]
  dataset[, X7_mcajeros_propios_descuentos_normalizada := ifelse(any(is.na(c(mcajeros_propios_descuentos, Media_mcajeros_propios_descuentos, SD_mcajeros_propios_descuentos))), 0, (mcajeros_propios_descuentos - Media_mcajeros_propios_descuentos) / SD_mcajeros_propios_descuentos)]
  dataset[, X7_mtarjeta_visa_descuentos_normalizada := ifelse(any(is.na(c(mtarjeta_visa_descuentos, Media_mtarjeta_visa_descuentos, SD_mtarjeta_visa_descuentos))), 0, (mtarjeta_visa_descuentos - Media_mtarjeta_visa_descuentos) / SD_mtarjeta_visa_descuentos)]
  dataset[, X7_mtarjeta_master_descuentos_normalizada := ifelse(any(is.na(c(mtarjeta_master_descuentos, Media_mtarjeta_master_descuentos, SD_mtarjeta_master_descuentos))), 0, (mtarjeta_master_descuentos - Media_mtarjeta_master_descuentos) / SD_mtarjeta_master_descuentos)]
  dataset[, X7_mcomisiones_mantenimiento_normalizada := ifelse(any(is.na(c(mcomisiones_mantenimiento, Media_mcomisiones_mantenimiento, SD_mcomisiones_mantenimiento))), 0, (mcomisiones_mantenimiento - Media_mcomisiones_mantenimiento) / SD_mcomisiones_mantenimiento)]
  dataset[, X7_mcomisiones_otras_normalizada := ifelse(any(is.na(c(mcomisiones_otras, Media_mcomisiones_otras, SD_mcomisiones_otras))), 0, (mcomisiones_otras - Media_mcomisiones_otras) / SD_mcomisiones_otras)]
  dataset[, X7_mforex_buy_normalizada := ifelse(any(is.na(c(mforex_buy, Media_mforex_buy, SD_mforex_buy))), 0, (mforex_buy - Media_mforex_buy) / SD_mforex_buy)]
  dataset[, X7_mforex_sell_normalizada := ifelse(any(is.na(c(mforex_sell, Media_mforex_sell, SD_mforex_sell))), 0, (mforex_sell - Media_mforex_sell) / SD_mforex_sell)]
  dataset[, X7_mtransferencias_recibidas_normalizada := ifelse(any(is.na(c(mtransferencias_recibidas, Media_mtransferencias_recibidas, SD_mtransferencias_recibidas))), 0, (mtransferencias_recibidas - Media_mtransferencias_recibidas) / SD_mtransferencias_recibidas)]
  dataset[, X7_mtransferencias_emitidas_normalizada := ifelse(any(is.na(c(mtransferencias_emitidas, Media_mtransferencias_emitidas, SD_mtransferencias_emitidas))), 0, (mtransferencias_emitidas - Media_mtransferencias_emitidas) / SD_mtransferencias_emitidas)]
  dataset[, X7_mextraccion_autoservicio_normalizada := ifelse(any(is.na(c(mextraccion_autoservicio, Media_mextraccion_autoservicio, SD_mextraccion_autoservicio))), 0, (mextraccion_autoservicio - Media_mextraccion_autoservicio) / SD_mextraccion_autoservicio)]
  dataset[, X7_mcheques_depositados_normalizada := ifelse(any(is.na(c(mcheques_depositados, Media_mcheques_depositados, SD_mcheques_depositados))), 0, (mcheques_depositados - Media_mcheques_depositados) / SD_mcheques_depositados)]
  dataset[, X7_mcheques_emitidos_normalizada := ifelse(any(is.na(c(mcheques_emitidos, Media_mcheques_emitidos, SD_mcheques_emitidos))), 0, (mcheques_emitidos - Media_mcheques_emitidos) / SD_mcheques_emitidos)]
  dataset[, X7_mcheques_depositados_rechazados_normalizada := ifelse(any(is.na(c(mcheques_depositados_rechazados, Media_mcheques_depositados_rechazados, SD_mcheques_depositados_rechazados))), 0, (mcheques_depositados_rechazados - Media_mcheques_depositados_rechazados) / SD_mcheques_depositados_rechazados)]
  dataset[, X7_mcheques_emitidos_rechazados_normalizada := ifelse(any(is.na(c(mcheques_emitidos_rechazados, Media_mcheques_emitidos_rechazados, SD_mcheques_emitidos_rechazados))), 0, (mcheques_emitidos_rechazados - Media_mcheques_emitidos_rechazados) / SD_mcheques_emitidos_rechazados)]
  dataset[, X7_matm_normalizada := ifelse(any(is.na(c(matm, Media_matm, SD_matm))), 0, (matm - Media_matm) / SD_matm)]
  dataset[, X7_matm_other_normalizada := ifelse(any(is.na(c(matm_other, Media_matm_other, SD_matm_other))), 0, (matm_other - Media_matm_other) / SD_matm_other)]
  dataset[, X7_Master_msaldototal_normalizada := ifelse(any(is.na(c(Master_msaldototal, Media_Master_msaldototal, SD_Master_msaldototal))), 0, (Master_msaldototal - Media_Master_msaldototal) / SD_Master_msaldototal)]
  dataset[, X7_Master_msaldopesos_normalizada := ifelse(any(is.na(c(Master_msaldopesos, Media_Master_msaldopesos, SD_Master_msaldopesos))), 0, (Master_msaldopesos - Media_Master_msaldopesos) / SD_Master_msaldopesos)]
  dataset[, X7_Master_msaldodolares_normalizada := ifelse(any(is.na(c(Master_msaldodolares, Media_Master_msaldodolares, SD_Master_msaldodolares))), 0, (Master_msaldodolares - Media_Master_msaldodolares) / SD_Master_msaldodolares)]
  dataset[, X7_Master_mconsumospesos_normalizada := ifelse(any(is.na(c(Master_mconsumospesos, Media_Master_mconsumospesos, SD_Master_mconsumospesos))), 0, (Master_mconsumospesos - Media_Master_mconsumospesos) / SD_Master_mconsumospesos)]
  dataset[, X7_Master_mconsumosdolares_normalizada := ifelse(any(is.na(c(Master_mconsumosdolares, Media_Master_mconsumosdolares, SD_Master_mconsumosdolares))), 0, (Master_mconsumosdolares - Media_Master_mconsumosdolares) / SD_Master_mconsumosdolares)]
  dataset[, X7_Master_madelantopesos_normalizada := ifelse(any(is.na(c(Master_madelantopesos, Media_Master_madelantopesos, SD_Master_madelantopesos))), 0, (Master_madelantopesos - Media_Master_madelantopesos) / SD_Master_madelantopesos)]
  dataset[, X7_Master_madelantodolares_normalizada := ifelse(any(is.na(c(Master_madelantodolares, Media_Master_madelantodolares, SD_Master_madelantodolares))), 0, (Master_madelantodolares - Media_Master_madelantodolares) / SD_Master_madelantodolares)]
  dataset[, X7_Master_mpagado_normalizada := ifelse(any(is.na(c(Master_mpagado, Media_Master_mpagado, SD_Master_mpagado))), 0, (Master_mpagado - Media_Master_mpagado) / SD_Master_mpagado)]
  dataset[, X7_Master_mpagospesos_normalizada := ifelse(any(is.na(c(Master_mpagospesos, Media_Master_mpagospesos, SD_Master_mpagospesos))), 0, (Master_mpagospesos - Media_Master_mpagospesos) / SD_Master_mpagospesos)]
  dataset[, X7_Master_mpagosdolares_normalizada := ifelse(any(is.na(c(Master_mpagosdolares, Media_Master_mpagosdolares, SD_Master_mpagosdolares))), 0, (Master_mpagosdolares - Media_Master_mpagosdolares) / SD_Master_mpagosdolares)]
  dataset[, X7_Master_mconsumototal_normalizada := ifelse(any(is.na(c(Master_mconsumototal, Media_Master_mconsumototal, SD_Master_mconsumototal))), 0, (Master_mconsumototal - Media_Master_mconsumototal) / SD_Master_mconsumototal)]
  dataset[, X7_Master_mpagominimo_normalizada := ifelse(any(is.na(c(Master_mpagominimo, Media_Master_mpagominimo, SD_Master_mpagominimo))), 0, (Master_mpagominimo - Media_Master_mpagominimo) / SD_Master_mpagominimo)]
  dataset[, X7_Visa_msaldototal_normalizada := ifelse(any(is.na(c(Visa_msaldototal, Media_Visa_msaldototal, SD_Visa_msaldototal))), 0, (Visa_msaldototal - Media_Visa_msaldototal) / SD_Visa_msaldototal)]
  dataset[, X7_Visa_msaldopesos_normalizada := ifelse(any(is.na(c(Visa_msaldopesos, Media_Visa_msaldopesos, SD_Visa_msaldopesos))), 0, (Visa_msaldopesos - Media_Visa_msaldopesos) / SD_Visa_msaldopesos)]
  dataset[, X7_Visa_msaldodolares_normalizada := ifelse(any(is.na(c(Visa_msaldodolares, Media_Visa_msaldodolares, SD_Visa_msaldodolares))), 0, (Visa_msaldodolares - Media_Visa_msaldodolares) / SD_Visa_msaldodolares)]
  dataset[, X7_Visa_mconsumospesos_normalizada := ifelse(any(is.na(c(Visa_mconsumospesos, Media_Visa_mconsumospesos, SD_Visa_mconsumospesos))), 0, (Visa_mconsumospesos - Media_Visa_mconsumospesos) / SD_Visa_mconsumospesos)]
  dataset[, X7_Visa_mconsumosdolares_normalizada := ifelse(any(is.na(c(Visa_mconsumosdolares, Media_Visa_mconsumosdolares, SD_Visa_mconsumosdolares))), 0, (Visa_mconsumosdolares - Media_Visa_mconsumosdolares) / SD_Visa_mconsumosdolares)]
  dataset[, X7_Visa_madelantopesos_normalizada := ifelse(any(is.na(c(Visa_madelantopesos, Media_Visa_madelantopesos, SD_Visa_madelantopesos))), 0, (Visa_madelantopesos - Media_Visa_madelantopesos) / SD_Visa_madelantopesos)]
  dataset[, X7_Visa_madelantodolares_normalizada := ifelse(any(is.na(c(Visa_madelantodolares, Media_Visa_madelantodolares, SD_Visa_madelantodolares))), 0, (Visa_madelantodolares - Media_Visa_madelantodolares) / SD_Visa_madelantodolares)]
  dataset[, X7_Visa_mpagado_normalizada := ifelse(any(is.na(c(Visa_mpagado, Media_Visa_mpagado, SD_Visa_mpagado))), 0, (Visa_mpagado - Media_Visa_mpagado) / SD_Visa_mpagado)]
  dataset[, X7_Visa_mpagospesos_normalizada := ifelse(any(is.na(c(Visa_mpagospesos, Media_Visa_mpagospesos, SD_Visa_mpagospesos))), 0, (Visa_mpagospesos - Media_Visa_mpagospesos) / SD_Visa_mpagospesos)]
  dataset[, X7_Visa_mpagosdolares_normalizada := ifelse(any(is.na(c(Visa_mpagosdolares, Media_Visa_mpagosdolares, SD_Visa_mpagosdolares))), 0, (Visa_mpagosdolares - Media_Visa_mpagosdolares) / SD_Visa_mpagosdolares)]
  dataset[, X7_Visa_mconsumototal_normalizada := ifelse(any(is.na(c(Visa_mconsumototal, Media_Visa_mconsumototal, SD_Visa_mconsumototal))), 0, (Visa_mconsumototal - Media_Visa_mconsumototal) / SD_Visa_mconsumototal)]
  dataset[, X7_Visa_mpagominimo_normalizada := ifelse(any(is.na(c(Visa_mpagominimo, Media_Visa_mpagominimo, SD_Visa_mpagominimo))), 0, (Visa_mpagominimo - Media_Visa_mpagominimo) / SD_Visa_mpagominimo)]




  # NO Elimino las variables que no utilizo
  comment <- '
