...
archivo_salida <- "./exp/HT2020/gridsearch_optimizado_3.txt"
...
for (vmax_depth in c(8)) {
  for (vmin_split in c(100, 200, 300, 400, 500, 600, 700, 800, 900, 2000)) {
    for (min_bucket in c(50, 100, 150, 200, 300, 400, 1000)) {
      for (cp in c(-0.3)) {
