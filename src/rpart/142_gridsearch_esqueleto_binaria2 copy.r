...
archivo_salida <- "./exp/HT2020/gridsearch_binario_SEMILLAS.txt"
...
for (vmax_depth in c(SEMILLAS)) {
  for (vmin_split in c(SEMILLLAS)) {
    for (min_bucket in c(SEMILLAS)) {
      for (cp in seq(SEMILLAS)) {
