...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  medias <- dataset[, .(Media_mrentabilidad := mean(mrentabilidad)), by = foto_mes]
  medias <- dataset[, .(Media_mrentabilidad_annual := mean(mrentabilidad_annual)), by = foto_mes]
  medias <- dataset[, .(Media_mcomisiones := mean(mcomisiones)), by = foto_mes]
  medias <- dataset[, .(Media_mactivos_margen = mean(mactivos_margen)), by = foto_mes]
  medias <- dataset[, .(Media_mpasivos_margen = mean(mpasivos_margen)), by = foto_mes]
  medias <- dataset[, .(Media_mcuenta_corriente_adicional = mean(mcuenta_corriente_adicional)), by = foto_mes]
  medias <- dataset[, .(Media_mcuenta_corriente = mean(mcuenta_corriente)), by = foto_mes]
  medias <- dataset[, .(Media_mcaja_ahorro = mean(mcaja_ahorro)), by = foto_mes]
  medias <- dataset[, .(Media_mcaja_ahorro_adicional = mean(mcaja_ahorro_adicional)), by = foto_mes]
  medias <- dataset[, .(Media_mcaja_ahorro_dolares = mean(mcaja_ahorro_dolares)), by = foto_mes]
  medias <- dataset[, .(Media_mcuentas_saldo = mean(mcuentas_saldo)), by = foto_mes]
  medias <- dataset[, .(Media_mautoservicio = mean(mautoservicio)), by = foto_mes]
  medias <- dataset[, .(Media_mtarjeta_visa_consumo = mean(mtarjeta_visa_consumo)), by = foto_mes]
  medias <- dataset[, .(Media_mtarjeta_master_consumo = mean(mtarjeta_master_consumo)), by = foto_mes]
  medias <- dataset[, .(Media_mprestamos_personales = mean(mprestamos_personales)), by = foto_mes]
  medias <- dataset[, .(Media_mprestamos_prendarios = mean(mprestamos_prendarios)), by = foto_mes]
  medias <- dataset[, .(Media_mprestamos_hipotecarios = mean(mprestamos_hipotecarios)), by = foto_mes]
  medias <- dataset[, .(Media_mplazo_fijo_dolares = mean(mplazo_fijo_dolares)), by = foto_mes]
  medias <- dataset[, .(Media_mplazo_fijo_pesos = mean(mplazo_fijo_pesos)), by = foto_mes]
  medias <- dataset[, .(Media_minversion1_pesos = mean(minversion1_pesos)), by = foto_mes]
  medias <- dataset[, .(Media_minversion1_dolares = mean(minversion1_dolares)), by = foto_mes]
  medias <- dataset[, .(Media_minversion2 = mean(minversion2)), by = foto_mes]
  medias <- dataset[, .(Media_mpayroll = mean(mpayroll)), by = foto_mes]
  medias <- dataset[, .(Media_mpayroll2 = mean(mpayroll2)), by = foto_mes]
  medias <- dataset[, .(Media_mcuenta_debitos_automaticos = mean(mcuenta_debitos_automaticos)), by = foto_mes]
  medias <- dataset[, .(Media_mttarjeta_visa_debitos_automaticos = mean(mttarjeta_visa_debitos_automaticos)), by = foto_mes]
  medias <- dataset[, .(Media_mttarjeta_master_debitos_automaticos = mean(mttarjeta_master_debitos_automaticos)), by = foto_mes]
  medias <- dataset[, .(Media_mpagodeservicios = mean(mpagodeservicios)), by = foto_mes]
  medias <- dataset[, .(Media_mpagomiscuentas = mean(mpagomiscuentas)), by = foto_mes]
  medias <- dataset[, .(Media_mcajeros_propios_descuentos = mean(mcajeros_propios_descuentos)), by = foto_mes]
  medias <- dataset[, .(Media_mtarjeta_visa_descuentos = mean(mtarjeta_visa_descuentos)), by = foto_mes]
  medias <- dataset[, .(Media_mtarjeta_master_descuentos = mean(mtarjeta_master_descuentos)), by = foto_mes]
  medias <- dataset[, .(Media_mcomisiones_mantenimiento = mean(mcomisiones_mantenimiento)), by = foto_mes]
  medias <- dataset[, .(Media_mcomisiones_otras = mean(mcomisiones_otras)), by = foto_mes]
  medias <- dataset[, .(Media_mforex_buy = mean(mforex_buy)), by = foto_mes]
  medias <- dataset[, .(Media_mforex_sell = mean(mforex_sell)), by = foto_mes]
  medias <- dataset[, .(Media_mtransferencias_recibidas = mean(mtransferencias_recibidas)), by = foto_mes]
  medias <- dataset[, .(Media_mtransferencias_emitidas = mean(mtransferencias_emitidas)), by = foto_mes]
  medias <- dataset[, .(Media_mextraccion_autoservicio = mean(mextraccion_autoservicio)), by = foto_mes]
  medias <- dataset[, .(Media_mcheques_depositados = mean(mcheques_depositados)), by = foto_mes]
  medias <- dataset[, .(Media_mcheques_emitidos = mean(mcheques_emitidos)), by = foto_mes]
  medias <- dataset[, .(Media_mcheques_depositados_rechazados = mean(mcheques_depositados_rechazados)), by = foto_mes]
  medias <- dataset[, .(Media_mcheques_emitidos_rechazados = mean(mcheques_emitidos_rechazados)), by = foto_mes]
  medias <- dataset[, .(Media_matm = mean(matm)), by = foto_mes]
  medias <- dataset[, .(Media_matm_other = mean(matm_other)), by = foto_mes]
  medias <- dataset[, .(Media_Master_msaldototal = mean(Master_msaldototal)), by = foto_mes]
  medias <- dataset[, .(Media_Master_msaldopesos = mean(Master_msaldopesos)), by = foto_mes]
  medias <- dataset[, .(Media_Master_msaldodolares = mean(Master_msaldodolares)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mconsumospesos = mean(Master_mconsumospesos)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mconsumosdolares = mean(Master_mconsumosdolares)), by = foto_mes]
  medias <- dataset[, .(Media_Master_madelantopesos = mean(Master_madelantopesos)), by = foto_mes]
  medias <- dataset[, .(Media_Master_madelantodolares = mean(Master_madelantodolares)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mpagado = mean(Master_mpagado)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mpagospesos = mean(Master_mpagospesos)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mpagosdolares = mean(Master_mpagosdolares)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mconsumototal = mean(Master_mconsumototal)), by = foto_mes]
  medias <- dataset[, .(Media_Master_mpagominimo = mean(Master_mpagominimo)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_msaldototal = mean(Visa_msaldototal)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_msaldopesos = mean(Visa_msaldopesos)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_msaldodolares = mean(Visa_msaldodolares)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mconsumospesos = mean(Visa_mconsumospesos)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mconsumosdolares = mean(Visa_mconsumosdolares)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_madelantopesos = mean(Visa_madelantopesos)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_madelantodolares = mean(Visa_madelantodolares)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mpagado = mean(Visa_mpagado)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mpagospesos = mean(Visa_mpagospesos)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mpagosdolares = mean(Visa_mpagosdolares)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mconsumototal = mean(Visa_mconsumototal)), by = foto_mes]
  medias <- dataset[, .(Media_Visa_mpagominimo = mean(Visa_mpagominimo)), by = foto_mes]

  desviaciones <- dataset[, .(SD_mrentabilidad = sd(mrentabilidad)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mrentabilidad_annual = sd(mrentabilidad_annual)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcomisiones = sd(mcomisiones)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mactivos_margen = sd(mactivos_margen)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mpasivos_margen = sd(mpasivos_margen)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcuenta_corriente_adicional = sd(mcuenta_corriente_adicional)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcuenta_corriente = sd(mcuenta_corriente)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcaja_ahorro = sd(mcaja_ahorro)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcaja_ahorro_adicional = sd(mcaja_ahorro_adicional)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcaja_ahorro_dolares = sd(mcaja_ahorro_dolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcuentas_saldo = sd(mcuentas_saldo)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mautoservicio = sd(mautoservicio)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtarjeta_visa_consumo = sd(mtarjeta_visa_consumo)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtarjeta_master_consumo = sd(mtarjeta_master_consumo)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mprestamos_personales = sd(mprestamos_personales)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mprestamos_prendarios = sd(mprestamos_prendarios)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mprestamos_hipotecarios = sd(mprestamos_hipotecarios)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mplazo_fijo_dolares = sd(mplazo_fijo_dolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mplazo_fijo_pesos = sd(mplazo_fijo_pesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_minversion1_pesos = sd(minversion1_pesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_minversion1_dolares = sd(minversion1_dolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_minversion2 = sd(minversion2)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mpayroll = sd(mpayroll)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mpayroll2 = sd(mpayroll2)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcuenta_debitos_automaticos = sd(mcuenta_debitos_automaticos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mttarjeta_visa_debitos_automaticos = sd(mttarjeta_visa_debitos_automaticos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mttarjeta_master_debitos_automaticos = sd(mttarjeta_master_debitos_automaticos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mpagodeservicios = sd(mpagodeservicios)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mpagomiscuentas = sd(mpagomiscuentas)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcajeros_propios_descuentos = sd(mcajeros_propios_descuentos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtarjeta_visa_descuentos = sd(mtarjeta_visa_descuentos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtarjeta_master_descuentos = sd(mtarjeta_master_descuentos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcomisiones_mantenimiento = sd(mcomisiones_mantenimiento)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcomisiones_otras = sd(mcomisiones_otras)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mforex_buy = sd(mforex_buy)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mforex_sell = sd(mforex_sell)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtransferencias_recibidas = sd(mtransferencias_recibidas)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mtransferencias_emitidas = sd(mtransferencias_emitidas)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mextraccion_autoservicio = sd(mextraccion_autoservicio)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcheques_depositados = sd(mcheques_depositados)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcheques_emitidos = sd(mcheques_emitidos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcheques_depositados_rechazados = sd(mcheques_depositados_rechazados)), by = foto_mes]
  desviaciones <- dataset[, .(SD_mcheques_emitidos_rechazados = sd(mcheques_emitidos_rechazados)), by = foto_mes]
  desviaciones <- dataset[, .(SD_matm = sd(matm)), by = foto_mes]
  desviaciones <- dataset[, .(SD_matm_other = sd(matm_other)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_msaldototal = sd(Master_msaldototal)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_msaldopesos = sd(Master_msaldopesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_msaldodolares = sd(Master_msaldodolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mconsumospesos = sd(Master_mconsumospesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mconsumosdolares = sd(Master_mconsumosdolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_madelantopesos = sd(Master_madelantopesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_madelantodolares = sd(Master_madelantodolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mpagado = sd(Master_mpagado)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mpagospesos = sd(Master_mpagospesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mpagosdolares = sd(Master_mpagosdolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mconsumototal = sd(Master_mconsumototal)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Master_mpagominimo = sd(Master_mpagominimo)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_msaldototal = sd(Visa_msaldototal)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_msaldopesos = sd(Visa_msaldopesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_msaldodolares = sd(Visa_msaldodolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mconsumospesos = sd(Visa_mconsumospesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mconsumosdolares = sd(Visa_mconsumosdolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_madelantopesos = sd(Visa_madelantopesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_madelantodolares = sd(Visa_madelantodolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mpagado = sd(Visa_mpagado)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mpagospesos = sd(Visa_mpagospesos)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mpagosdolares = sd(Visa_mpagosdolares)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mconsumototal = sd(Visa_mconsumototal)), by = foto_mes]
  desviaciones <- dataset[, .(SD_Visa_mpagominimo = sd(Visa_mpagominimo)), by = foto_mes]
